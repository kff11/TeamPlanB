...
public class LikeRecyclerViewAdapter extends RecyclerView.Adapter<LikeRecyclerViewAdapter.ItemViewHolder> {
    ...
    public ItemViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        view = LayoutInflater.from(context).inflate(R.layout.like_recyclerview_item, parent, false);
    ...
    class ItemViewHolder extends RecyclerView.ViewHolder {
        ...
        void onBind(final RecyclerViewItem item) {
            title = itemView.findViewById(R.id.like_item_name);
            img = itemView.findViewById(R.id.like_item_imageView);
            layout = itemView.findViewById(R.id.like_item_layout);
